...
class Animator:
    ...
    def update(self, data):
        ...
        # Print time and coordinates
        print("Time: {:6.2f} s".format(self.time))
        print("Coordinates: x={}, y={}".format(data[2, 0], data[2, 1]))
...
pendulum = Pendulum(theta1=sp.pi, theta2=sp.pi - 0.01, dt=0.1)
